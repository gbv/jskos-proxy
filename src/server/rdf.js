...
// Guess requested format from Accept-header and query parameter
export function requestFormat(req) {
  // ? For requests that support */* (e.g. plain curl), currently HTML will be used. Should JSON be used instead?
  const formats = [
